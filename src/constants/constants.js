...
export const API_ROUTES = {
  ...
  ADD_PAYMENT_DETAILS: '/pharmacy/savePaymentBreakup',
  ...
  MARK_NOTIFICATION_AS_READ: '/notifications',
  ...
  DELETE_MESSAGE: '/teams/chats',
  ADD_CHAT_MEMBERS: '/teams/chats',
  REMOVE_CHAT_MEMBER: '/teams/chats',
  GET_USER_MEETINGS: '/teams/meetings',
  CREATE_MEETING: '/teams/meetings',
  UPDATE_MEETING: '/teams/meetings',
  JOIN_MEETING: '/teams/meetings',
  GET_CALENDAR_EVENTS: '/teams/calendar/events',
  CREATE_CALENDAR_EVENT: '/teams/calendar/events',
  UPDATE_CALENDAR_EVENT: '/teams/calendar/events',
  DELETE_CALENDAR_EVENT: '/teams/calendar/events',
  GET_SCHEDULES: '/teams/scheduling',
  CREATE_SCHEDULE: '/teams/scheduling',
  UPDATE_SCHEDULE: '/teams/scheduling',
  DELETE_SCHEDULE: '/teams/scheduling',
  INITIATE_CALL: '/teams/calls',
  UPDATE_CALL_STATUS: '/teams/calls',
  GET_CALL_HISTORY: '/teams/calls/history',
