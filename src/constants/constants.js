...
export const API_ROUTES = {
  ...
  GET_REFERRING_DOCTORS: '/patients/referringDoctors',
  CREATE_REFERRING_DOCTOR: '/patients/referringDoctors',
  UPDATE_REFERRING_DOCTOR: '/patients/referringDoctors',
  GET_REFERRING_DOCTORS_LOG: '/patients/referringDoctors/logs',
  GET_NEW_PATIENT_TRACKER: '/patients/new-tracker',
  GET_ALL_PATIENT_TRACKER: '/patient-tracker/all',
  GET_PATIENT_TRACKER_SUMMARY_AUTOMATED: '/patient-tracker/summary-automated',
  GET_PATIENT_TRACKER_BY_PATIENT: '/patient-tracker/by-patient',
  ...
  GET_UPT_RESULTS: '/scan/getUptResults',
  SAVE_UPT_RESULT: '/scan/saveUptResult',
  EDIT_UPT_RESULT: '/scan/editUptResult',
  DELETE_UPT_RESULT: '/scan/deleteUptResult/',
